    ...
    <>
      ...
      <div className="flex overflow-hidden bg-white pt-16 dark:bg-slate-900 dark:border-slate-700">
                ...
                <ul className="space-y-2 pb-2">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-base capitalize text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group dark:text-white dark:hover:text-black"
                      >
        ...
        >
          ...
          <p className="text-center text-sm text-gray-500 my-10 dark:text-black">
